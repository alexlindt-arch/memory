...
| **bis 560 px** | die Spielleiste wird wieder ein einziges getöntes Kästchen wie im Desktop-Design, nur zweizeilig: oben aktueller Spieler links und „Exit game" rechts, darunter der Punktestand. Auch die Summary-Leiste im Settings-Screen passt nicht mehr auf eine Zeile – Theme, Spieler und Größe behalten ihre gemeinsame Zeile, „Start" rückt zentriert darunter. |
