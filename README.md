...
| **769 – 1439 px** | ab hier greift die Laptop-Ansicht: die feste Design-Bühne 1440 × 1024 wird per `transform: scale()` heruntergerechnet – alle Abstände bleiben pixelgenau wie im Entwurf. |
