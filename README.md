...
| **bis 768 px** | die Spielleiste passt nicht mehr auf eine Zeile und wird zweizeilig: oben der aktuelle Spieler links und „Exit game" rechts, darunter der Punktestand. Sie bleibt dabei eine getönte Fläche wie im Desktop-Design und ist genau so breit wie das Spielfeld, damit „Exit game" bündig mit dem rechten Rand der Karten sitzt. Punktestand und aktueller Spieler sind bewusst groß gesetzt, der Exit-Button gibt ihnen dafür Platz zurück. |
