...
| Bereich | Verhalten |
|---|---|
| **bis 768 px** | zusätzlich zum Flow-Layout wird die Spielleiste aufgelöst: „Exit game" steht oben rechts, Punktestand und aktueller Spieler folgen darunter als eigene, button-artige Karten mit Radius, Rahmen in der Theme-Farbe und Schatten. Die beiden Karten sind nur so breit wie ihr Inhalt und wachsen nicht mit dem Bildschirm mit. |
