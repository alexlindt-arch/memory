...
| **769 – 1439 px** | ab hier greift die Laptop-Ansicht: die feste Design-Bühne 1440 × 1024 wird per `transform: scale()` heruntergerechnet – alle Abstände bleiben pixelgenau wie im Entwurf. Skaliert wird dabei auf die Fläche, die das Design tatsächlich füllt (1260 × 950), nicht auf die Bühne selbst. Nur deren leere Ränder laufen dadurch über den Bildschirmrand hinaus, und auf einem Laptop wird alles rund 8–14 % größer. Die Bühne wird zusätzlich so verschoben, dass der Inhalt des jeweiligen Screens senkrecht in der Fenstermitte steht – jeder Screen füllt die 1024 px hohe Bühne anders aus. Rein dekorative Teile (Wasserzeichen, Konfetti) zählen dabei nicht mit. |
